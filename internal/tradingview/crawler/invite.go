...
// InviteUser ...
func (c *Crawler) InviteUser(scriptID, username string) error {
	...
	//flag.Parse()
	//
	//cookies, err := c.Cache.GetCookies()
	//if err != nil {
	//
	//	return err
	//}
	//// cast cookie from store into TradingView cookie
	//tvCookie := cookies.(tradingview.TVCookie)
	//
	//// cookies
	...
	//	"_ga":         tvCookie.GA,
	//	"_gid":        tvCookie.GID,
	//	"_sp_id.cf1a": tvCookie.SPID,
	//	"device_t":    tvCookie.Device,
	//	"sessionid":   tvCookie.SessionID,
	//	"theme":       tvCookie.Theme,
	//	"tv_ecuid":    tvCookie.TVECUID,
	//}
	//
